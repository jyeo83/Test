...
namespace Test.Controllers
{
    ...
    public class SamlController : Controller
    {
        ...
        public SamlController(
            ...
            IConfigurationToMetadata configurationMetadata,
            IConfiguration configuration)
        {
            _userManager = userManager;
            _signInManager = signInManager;
            _samlServiceProvider = samlServiceProvider;
            _configurationToMetadata = configurationMetadata;
        ...
        public async Task<IActionResult> AssertionConsumerService()
        {
            ...
            var testAtt = ssoResult.Attributes.Where(a => a.FriendlyName == "mail").SingleOrDefault();
            ...
            if (user == null)
            {
                user = new User { UserName = ssoResult.UserID, Email = ssoResult.UserID };
            ...
            //return Redirect("https://prodmssamltrial.azurewebsites.net");
